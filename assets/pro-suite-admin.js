...
function renderAudit(){
 const arr=Object.entries(audit||{}).map(([id,x])=>({id,...x})).sort((a,b)=>(b.createdAt||0)-(a.createdAt||0)),labels={question_submitted:'إرسال سؤال',question_approved:'اعتماد سؤال',question_rejected:'رفض سؤال',auto_quiz_submitted:'إنشاء اختبار تلقائي',certificate_registered:'تسجيل شهادة',role_updated:'تعديل صلاحية',teacher_content_approved:'اعتماد محتوى معلم',teacher_content_rejected:'رفض محتوى معلم',teacher_profile_approved:'اعتماد ملف معلم',teacher_profile_rejected:'رفض ملف معلم'};
