const CACHE='academy-shell-2026-09-26-v38';
const CORE=[
 ...
 './assets/experience.css?v=38','./assets/academy-utils.js',
 ...
 './assets/app.js?v=38','./assets/learning.js?v=34','./assets/explore.js','./assets/search.js','./assets/news.js','./assets/profile.js',
 ...
 './assets/activity-tracker.js','./assets/admin-auth-flow.js?v=33','./assets/admin.js?v=34','./assets/admin-notifications.js','./assets/teacher.js?v=34','./assets/teacher-profile.js?v=34','./assets/certificate.js','./assets/pwa.js','./assets/dashboard-hero.jpg','./assets/app-icon.svg','./manifest.webmanifest'
];
