const CACHE='academy-shell-2026-09-25-v32';
const CORE=[
 ...
 './assets/activity-tracker.js','./assets/admin-auth-flow.js?v=32','./assets/admin.js?v=32','./assets/admin-notifications.js','./assets/teacher.js?v=32','./assets/certificate.js','./assets/pwa.js','./assets/dashboard-hero.jpg','./assets/app-icon.svg','./manifest.webmanifest'
];
